            ...
            <div className="space-y-8">
              <div>
                ...
                <p
                  ...
                  style={{ color: "var(--foreground)" }}
                >
                  I&apos;m here to help you navigate your transformation
                  journey. Whether you&apos;re looking to implement AI
                  solutions, transition to remote work, or access growth
                  resources, let&apos;s discuss how we can work together.
                </p>
              </div>
