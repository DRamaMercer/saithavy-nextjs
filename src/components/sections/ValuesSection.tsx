...
const values = [
  {
    ...
    frontGradient: "linear-gradient(to bottom right, #1a365d, rgba(26,54,93,0.9))",
    borderColor: "#1a365d",
    titleColor: "#1a365d",
    icon: (
  ...
  },
  {
    ...
    frontGradient: "linear-gradient(to bottom right, #c05621, rgba(192,86,33,0.9))",
    borderColor: "#c05621",
    titleColor: "#c05621",
    icon: (
  ...
  },
  {
    ...
    frontGradient: "linear-gradient(to bottom right, #68d391, rgba(104,211,145,0.9))",
    borderColor: "#68d391",
    titleColor: "#68d391",
    icon: (
  ...
  },
  {
    ...
    frontGradient: "linear-gradient(to bottom right, #718096, rgba(113,128,150,0.9))",
    borderColor: "#718096",
    titleColor: "#718096",
    icon: (
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="reveal-text text-xl max-w-3xl mx-auto" style={{ color: "var(--foreground)" }}>
            These principles guide everything I do and shape how I help others grow.
          </p>
        </div>
