...
const LeadCaptureForm: React.FC<LeadCaptureFormProps> = ({
  ...
  if (variant === "popup") {
    return (
      <div className="bg-linear-gradient-to-br from-blueprint-navy to-[#2D3A50] text-white rounded-xl p-8 text-center">
        <Mail className="w-12 h-12 mx-auto mb-4 text-blueprint-terracotta" />
        <h3 className="text-2xl font-bold mb-2 font-poppins">
          Unlock This Resource
        </h3>
        <p className="text-white/80 mb-6">
          Enter your email to access this free resource and get updates on
          similar tools.
        </p>
