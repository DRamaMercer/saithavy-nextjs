    ...
    >
      ...
      >
        ...
        <div className="p-8">
          ...
          {/* Title */}
          <h2 className="font-[family-name:var(--font-poppins)] font-bold text-2xl md:text-3xl mb-4" style={{ color: 'var(--heading)' }}>
            {resource.title}
          </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-xs" style={{ color: 'var(--foreground)' }}>Time</p>
                <p className="text-sm font-semibold" style={{ color: 'var(--heading)' }}>{resource.timeToRead}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-xs" style={{ color: 'var(--foreground)' }}>Level</p>
                <p className="text-sm font-semibold" style={{ color: 'var(--heading)' }}>{resource.difficulty}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-xs" style={{ color: 'var(--foreground)' }}>Downloads</p>
                <p className="text-sm font-semibold" style={{ color: 'var(--heading)' }}>{resource.downloads.toLocaleString()}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-xs" style={{ color: 'var(--foreground)' }}>Audience</p>
                <p className="text-sm font-semibold" style={{ color: 'var(--heading)' }}>{resource.targetAudience}</p>
              </div>
            </div>
          </div>
          ...
          {resource.whatYoullLearn && resource.whatYoullLearn.length > 0 && (
            <div className="mb-6">
              <h3 className="font-[family-name:var(--font-poppins)] font-semibold text-lg mb-3" style={{ color: 'var(--heading)' }}>
                What You'll Learn
              </h3>
